  ...
  return (
    <div className="min-h-[520px] overflow-hidden rounded-md border bg-background">
      <div className="flex items-center justify-between border-b bg-muted/40 px-4 py-3">
        <div>
          <div className="text-sm font-medium">Topology canvas</div>
          <div className="text-xs text-muted-foreground">{nodes.length} resources · {edges.length} links</div>
        </div>
        <div className="rounded-md border bg-background px-2 py-1 text-xs text-muted-foreground">IaC view</div>
      </div>
  ...
  return (
    <section className="rounded-md border bg-card/95 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b px-4 py-3">
        ...
        <div className="rounded-md border px-2 py-1 text-xs text-muted-foreground">{network.nat ? "nat" : "routed"}</div>
      </div>
