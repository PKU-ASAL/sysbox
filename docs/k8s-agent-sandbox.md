...
URL Source: https://agent-sandbox.sigs.k8s.io/docs/

Markdown Content:
### Agent Sandbox

## What is Agent Sandbox? [](https://agent-sandbox.sigs.k8s.io/docs/#what-is-agent-sandbox)
...
## Why Agent Sandbox? [](https://agent-sandbox.sigs.k8s.io/docs/#why-agent-sandbox)

### Fast sandbox provisioning [](https://agent-sandbox.sigs.k8s.io/docs/#fast-sandbox-provisioning)
...
### Strong, configurable isolation [](https://agent-sandbox.sigs.k8s.io/docs/#strong-configurable-isolation)
...
### Stable identity and persistent storage [](https://agent-sandbox.sigs.k8s.io/docs/#stable-identity-and-persistent-storage)
...
### Lifecycle management built in [](https://agent-sandbox.sigs.k8s.io/docs/#lifecycle-management-built-in)
...
### Kubernetes-native and extensible [](https://agent-sandbox.sigs.k8s.io/docs/#kubernetes-native-and-extensible)
...
### Client SDKs for programmatic access [](https://agent-sandbox.sigs.k8s.io/docs/#client-sdks-for-programmatic-access)

Agent Sandbox provides first-class clients for both [Python](https://agent-sandbox.sigs.k8s.io/docs/python-client/) and [Go](https://agent-sandbox.sigs.k8s.io/docs/go-client/), so agents and applications can create, query, and manage sandboxes programmatically in the language that best fits their runtime and platform.

## Core capabilities [](https://agent-sandbox.sigs.k8s.io/docs/#core-capabilities)
...
## Where to go next [](https://agent-sandbox.sigs.k8s.io/docs/#where-to-go-next)