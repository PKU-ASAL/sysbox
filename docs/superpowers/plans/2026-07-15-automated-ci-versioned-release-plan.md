...
- [ ] **Step 1: Obtain and verify the official license text**
...
- [ ] **Step 2: Add the root license and README declaration**
...
- [ ] **Step 1: Write failing buildinfo tests**
...
- [ ] **Step 4: Write failing Cobra command tests**
...
- [ ] **Step 5: Implement and verify the command**
...
- [ ] **Step 3: Implement shared validation and deterministic build**
...
- [ ] **Step 5: Add Make targets and verify GREEN**
...
- [ ] **Step 1: Add failing static OCI contract tests**
...
- [ ] **Step 2: Make Dockerfile and Compose version-aware**
...
- [ ] **Step 3: Implement OCI preflight and publication**
...
- [ ] **Step 2: Implement Forgejo REST publication script**
...
- [ ] **Step 3: Implement thin workflows**
...
- [ ] **Step 4: Add workflow test target and verify**
...
- [ ] **Step 1: Document runner and credential setup**
...
- [ ] **Step 2: Document license and installation paths**
